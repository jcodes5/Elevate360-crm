...
var AuthService = /** @class */ (function () {
    ...
    AuthService.comparePassword = function (password, hashedPassword) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    AuthService.generateTokens = function (user) {
        ...
        var token = jsonwebtoken_1.default.sign(payload, JWT_SECRET, { expiresIn: "15m" });
    ...
    AuthService.verifyRefreshToken = function (refreshToken) {
        try {
